...
**base_asset** | **String** | Base asset being traded | 
**quote_asset** | **String** | Quote asset (payment currency) | 
...
**created_at_date_time** | Option<**String**> | Quote creation timestamp in ISO 8601 format | [optional]
...
**expire_at_date_time** | Option<**String**> | Quote expiration timestamp in ISO 8601 format | [optional]
