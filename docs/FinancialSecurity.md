...
**scale** | Option<**i32**> | Scale | [optional]
**min_quantity** | Option<**String**> | Decimal value as string to preserve precision | [optional]
**lot_size** | Option<**String**> | Decimal value as string to preserve precision | [optional]
