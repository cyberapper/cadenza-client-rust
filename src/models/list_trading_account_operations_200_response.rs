...
pub struct ListTradingAccountOperations200Response {
    ...
    pub data: Option<Vec<models::AccountOperation>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl ListTradingAccountOperations200Response {
    pub fn new(errno: i32) -> ListTradingAccountOperations200Response {
