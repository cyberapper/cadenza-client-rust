...
pub struct SyncMarketInstrumentsResponseData {
    /// Total number of instruments synced
    #[serde(rename = "total")]
    pub total: i32,
}

impl SyncMarketInstrumentsResponseData {
    pub fn new(total: i32) -> SyncMarketInstrumentsResponseData {
        SyncMarketInstrumentsResponseData { total }
    }
}
