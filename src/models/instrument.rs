...
impl Instrument {
    pub fn new(
        ...
        instrument_type: models::InstrumentType,
        status: models::InstrumentStatus,
        base_asset: String,
        quote_asset: String,
        base_precision: i32,
        quote_precision: i32,
        base_max_significant: Option<i32>,
        quote_max_significant: Option<i32>,
        lot_size: String,
        pip_size: String,
        base_scale: Option<i32>,
        quote_scale: Option<i32>,
        min_quantity: String,
        max_quantity: String,
        min_notional: String,
        order_types: Vec<models::OrderType>,
        time_in_force_options: Vec<models::TimeInForce>,
    ) -> Instrument {
        Instrument {
            instrument_id,
            venue,
