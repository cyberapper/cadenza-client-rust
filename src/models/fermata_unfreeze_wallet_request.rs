...
pub struct FermataUnfreezeWalletRequest {
    /// UUID string
    #[serde(rename = "walletId")]
    pub wallet_id: uuid::Uuid,
}

impl FermataUnfreezeWalletRequest {
    pub fn new(wallet_id: uuid::Uuid) -> FermataUnfreezeWalletRequest {
        FermataUnfreezeWalletRequest { wallet_id }
    }
}
