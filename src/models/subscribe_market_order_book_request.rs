...
pub struct SubscribeMarketOrderBookRequest {
    /// Instrument ID in format {VENUE}:{BASE}/{QUOTE}
    #[serde(rename = "instrumentId")]
    pub instrument_id: String,
}

impl SubscribeMarketOrderBookRequest {
    pub fn new(instrument_id: String) -> SubscribeMarketOrderBookRequest {
        SubscribeMarketOrderBookRequest { instrument_id }
    }
}
