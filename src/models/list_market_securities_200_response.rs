...
pub struct ListMarketSecurities200Response {
    ...
    pub data: Option<Vec<models::FinancialSecurity>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl ListMarketSecurities200Response {
    pub fn new(errno: i32) -> ListMarketSecurities200Response {
