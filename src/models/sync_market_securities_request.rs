...
pub struct SyncMarketSecuritiesRequest {
    #[serde(rename = "venue")]
    pub venue: models::Venue,
}

impl SyncMarketSecuritiesRequest {
    pub fn new(venue: models::Venue) -> SyncMarketSecuritiesRequest {
        SyncMarketSecuritiesRequest { venue }
    }
}
