...
pub struct RpcSyncInstrumentsResult {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RpcSyncInstrumentsResultData>>,
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<Box<models::RpcError>>,
}

impl RpcSyncInstrumentsResult {
    /// Response for instrument sync
    pub fn new() -> RpcSyncInstrumentsResult {
