...
pub struct SubmitTradeOrder200Response {
    ...
    pub data: Option<Vec<models::TradeOrder>>,
}

impl SubmitTradeOrder200Response {
    pub fn new(errno: i32) -> SubmitTradeOrder200Response {
