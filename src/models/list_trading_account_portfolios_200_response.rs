...
pub struct ListTradingAccountPortfolios200Response {
    ...
    pub data: Option<Vec<models::Portfolio>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl ListTradingAccountPortfolios200Response {
    pub fn new(errno: i32) -> ListTradingAccountPortfolios200Response {
