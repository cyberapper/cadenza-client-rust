...
pub struct FermataListWallets200Response {
    ...
    pub data: Option<Vec<models::FermataWallet>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl FermataListWallets200Response {
    pub fn new(errno: i32) -> FermataListWallets200Response {
