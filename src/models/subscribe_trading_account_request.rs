...
pub struct SubscribeTradingAccountRequest {
    /// UUID string
    #[serde(rename = "tradingAccountId")]
    pub trading_account_id: uuid::Uuid,
}

impl SubscribeTradingAccountRequest {
    pub fn new(trading_account_id: uuid::Uuid) -> SubscribeTradingAccountRequest {
        SubscribeTradingAccountRequest { trading_account_id }
    }
}
