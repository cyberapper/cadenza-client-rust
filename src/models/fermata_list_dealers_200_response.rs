...
pub struct FermataListDealers200Response {
    ...
    pub data: Option<Vec<models::FermataDealer>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl FermataListDealers200Response {
    pub fn new(errno: i32) -> FermataListDealers200Response {
