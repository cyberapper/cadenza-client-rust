...
pub struct ConnectTradingAccount200Response {
    ...
    pub data: Option<Box<models::TradingAccount>>,
}

impl ConnectTradingAccount200Response {
    pub fn new(errno: i32) -> ConnectTradingAccount200Response {
