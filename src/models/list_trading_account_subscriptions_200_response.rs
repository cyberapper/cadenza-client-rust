...
pub struct ListTradingAccountSubscriptions200Response {
    ...
    pub data: Option<Vec<models::Subscription>>,
}

impl ListTradingAccountSubscriptions200Response {
    pub fn new(errno: i32) -> ListTradingAccountSubscriptions200Response {
