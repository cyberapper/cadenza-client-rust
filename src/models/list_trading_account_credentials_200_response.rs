...
pub struct ListTradingAccountCredentials200Response {
    ...
    pub data: Option<Vec<models::TradingAccountCredential>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl ListTradingAccountCredentials200Response {
    pub fn new(errno: i32) -> ListTradingAccountCredentials200Response {
