...
pub struct RpcDisableTradingAccountParams {
    #[serde(rename = "tradingAccountId")]
    pub trading_account_id: uuid::Uuid,
}

impl RpcDisableTradingAccountParams {
    /// Request to disable a trading account
    pub fn new(trading_account_id: uuid::Uuid) -> RpcDisableTradingAccountParams {
        RpcDisableTradingAccountParams { trading_account_id }
    }
}
