...
pub struct DeleteMarketSecurity200Response {
    ...
    pub data: Option<Box<models::FinancialSecurity>>,
}

impl DeleteMarketSecurity200Response {
    pub fn new(errno: i32) -> DeleteMarketSecurity200Response {
