...
pub struct CreateTradingAccountCredential200Response {
    ...
    pub data: Option<Box<models::TradingAccountCredential>>,
}

impl CreateTradingAccountCredential200Response {
    pub fn new(errno: i32) -> CreateTradingAccountCredential200Response {
