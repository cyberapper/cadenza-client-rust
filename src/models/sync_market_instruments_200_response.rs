...
pub struct SyncMarketInstruments200Response {
    ...
    pub data: Option<Box<models::SyncMarketInstrumentsResponseData>>,
}

impl SyncMarketInstruments200Response {
    pub fn new(errno: i32) -> SyncMarketInstruments200Response {
