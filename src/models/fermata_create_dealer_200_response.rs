...
pub struct FermataCreateDealer200Response {
    ...
    pub data: Option<Box<models::FermataDealer>>,
}

impl FermataCreateDealer200Response {
    pub fn new(errno: i32) -> FermataCreateDealer200Response {
