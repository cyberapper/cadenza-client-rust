...
pub struct FermataCreateWallet200Response {
    ...
    pub data: Option<Box<models::FermataWallet>>,
}

impl FermataCreateWallet200Response {
    pub fn new(errno: i32) -> FermataCreateWallet200Response {
