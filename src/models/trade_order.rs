...
impl TradeOrder {
    pub fn new(trade_order_id: uuid::Uuid, trading_account_id: uuid::Uuid, venue: models::Venue, instrument_id: String, base_asset: String, quote_asset: String, order_side: models::OrderSide, order_type: Option<models::OrderType>, time_in_force: Option<models::TimeInForce>, status: Option<models::OrderStatus>, quantity: String, order_quantity_type: models::OrderQuantityType, executed_price: String, executed_quantity: String, executed_cost: String, fees: Vec<models::SecurityQuantity>, created_at: i64, updated_at: i64) -> TradeOrder {
        TradeOrder {
            trade_order_id,
            order_list_id: None,
