...
pub struct DisableMarketInstrumentRequest {
    /// Instrument ID in format {VENUE}:{BASE}/{QUOTE}
    #[serde(rename = "instrumentId")]
    pub instrument_id: String,
}

impl DisableMarketInstrumentRequest {
    pub fn new(instrument_id: String) -> DisableMarketInstrumentRequest {
        DisableMarketInstrumentRequest { instrument_id }
    }
}
