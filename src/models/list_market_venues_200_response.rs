...
pub struct ListMarketVenues200Response {
    ...
    pub data: Option<Vec<models::MarketVenue>>,
}

impl ListMarketVenues200Response {
    pub fn new(errno: i32) -> ListMarketVenues200Response {
