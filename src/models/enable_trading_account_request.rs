...
pub struct EnableTradingAccountRequest {
    /// UUID string
    #[serde(rename = "tradingAccountId")]
    pub trading_account_id: uuid::Uuid,
}

impl EnableTradingAccountRequest {
    pub fn new(trading_account_id: uuid::Uuid) -> EnableTradingAccountRequest {
        EnableTradingAccountRequest { trading_account_id }
    }
}
