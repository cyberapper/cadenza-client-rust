...
pub struct VerifyTradingAccountCredential200Response {
    ...
    pub data: Option<Vec<models::TradingAccount>>,
}

impl VerifyTradingAccountCredential200Response {
    pub fn new(errno: i32) -> VerifyTradingAccountCredential200Response {
