...
pub struct CancelTradeOrder200Response {
    ...
    pub data: Option<Box<models::TradeOrder>>,
}

impl CancelTradeOrder200Response {
    pub fn new(errno: i32) -> CancelTradeOrder200Response {
