...
pub struct SubscribeTradingAccount200Response {
    ...
    pub data: Option<Box<models::Subscription>>,
}

impl SubscribeTradingAccount200Response {
    pub fn new(errno: i32) -> SubscribeTradingAccount200Response {
