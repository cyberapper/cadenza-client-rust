...
pub struct ListMarketInstruments200Response {
    ...
    pub data: Option<Vec<models::Instrument>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl ListMarketInstruments200Response {
    pub fn new(errno: i32) -> ListMarketInstruments200Response {
